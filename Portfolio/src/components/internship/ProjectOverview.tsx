  ...
  return (
      <div className="sectionContainer5">
          ...
          <div className="card ">
              ...
              <h3 className="text-2xl font-bold text-[#d1e4d0] mb-4">Python & Django</h3>
              <p className="text-lg leading-relaxed text-[#d1e4d0] mb-4">
          ...
          <div className="card ">
              <img src="/assets/img/foto/Project_Beja/Postgre_sql.png" alt="Logo" className="foto-card"/>
                <h3 className="text-2xl font-bold text-[#d1e4d0] mb-4">PostgreSQL</h3>
              <p className="text-lg leading-relaxed text-[#d1e4d0] mb-4">
          ...
          <div className="card ">
              ...
              <h3 className="text-2xl font-bold text-[#d1e4d0] mb-4">Grafana</h3>
              <p className="text-lg leading-relaxed text-[#d1e4d0] mb-4">
          ...
          <div className="card ">
              <img
                ...
                <h3 className="text-2xl font-bold text-[#d1e4d0] mb-4">Agile Methodologies</h3>
              <p className="text-lg leading-relaxed text-[#d1e4d0] mb-4">
